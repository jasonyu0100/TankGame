...
Public Class InGameOptions
    ...
    'Imports pictures
    Public defaultTankLocation = Application.StartupPath() & "\resources\Images\tank.png"
    Public defaultTurretLocation = Application.StartupPath() & "\resources\Images\turret.png"
    ...
    Public defaultMountainBoxLocation = Application.StartupPath() & "\resources\Images\mountain.png"
